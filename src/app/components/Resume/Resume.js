...
const Resume = (props) => {
    ...
    let showEducation = education && education.length > 0;
    let showExperience = experience && experience.length > 0;
                                    ...
                                    <h1 className="section__header">Education</h1>
                                    {
                                        education.map((item, index) =>
                                            <div className="row section-education__content" key={index}>
                                                <div className="col-3">{`${item.startYear} - ${item.isCurrent ? "current" : `${item.endYear}`}`}</div>
